...
%changelog
* Tue Aug 11 2026 Andrii Sultanov <andriy.sultanov@vates.tech> - 24.1.0-96.1
- Sync with 24.1.0-96
- *** Upstream changelog ***
  [only rebuilds]

* Mon Jun 22 2026 Andrii Sultanov <andriy.sultanov@vates.tech> - 24.1.0-93.1
- Sync with 24.1.0-93
- *** Upstream changelog ***
  [only rebuilds]
...
* Fri Feb 20 2026 Philippe Coval <philippe.coval@vates.tech> -  24.1.0-83.2
- Rebuild with XAPI 26.1.3-1.2 (with openssl-3)

* Wed Feb 18 2026 Pau Ruiz Safont <pau.safont@vates.tech> - 24.1.0-83.1
- Sync with 24.1.0-83
- *** Upstream changelog ***
  [only rebuilds]

* Mon Nov 24 2025 Pau Ruiz Safont <pau.safont@vates.tech> - 24.1.0-71.1
- Sync with 24.1.0-71
- *** Upstream changelog ***
  [only rebuilds]
  
* Tue Sep 09 2025 Samuel Verschelde <stormi-xcp@ylix.fr> - 24.1.0-65.1
- Sync with 24.1.0-65
- *** Upstream changelog ***
  [only rebuilds]
